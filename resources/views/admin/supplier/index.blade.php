                                ...
                                <tbody>
                                    @foreach($supplier as $key => $supplier)
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                <a href="{{url('/delete-supplier/'.$supplier->id)}}" class="btn btn-xs btn-danger btn-flat" onclick="
                                                  return confirm('Anda Yakin Akan Menghapus Data ?');"><i class="fa fa-trash"></i></a>
                                                <a href="{{url('/form-supplier/'.$supplier->id)}}" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-edit"></i></a>
                                                </center>
                                            </td>
                                        </tr>
